...
EOF
    ...
    # Copy rr.conf from attack profiles (optimized for false base station)
    echo "Copying rr.conf from attack profiles..."
    if [ -f "../configs/attack_profiles/rr.conf" ]; then
        sudo cp ../configs/attack_profiles/rr.conf /etc/srsran/rr.conf
        echo "✓ rr.conf copied from attack profiles"
    else
        echo "Warning: Attack profile rr.conf not found, using default"
...
EOF
    ...
    # Copy rb.conf from attack profiles (optimized for false base station)
    echo "Copying rb.conf from attack profiles..."
    if [ -f "../configs/attack_profiles/rb.conf" ]; then
        sudo cp ../configs/attack_profiles/rb.conf /etc/srsran/rb.conf
        echo "✓ rb.conf copied from attack profiles"
    else
        echo "Warning: Attack profile rb.conf not found, using default"
...
EOF
    ...
    # Copy sib.conf from attack profiles (optimized for false base station)
    echo "Copying sib.conf from attack profiles..."
    if [ -f "../configs/attack_profiles/sib.conf" ]; then
        sudo cp ../configs/attack_profiles/sib.conf /etc/srsran/sib.conf
        echo "✓ sib.conf copied from attack profiles"
    else
        echo "Warning: Attack profile sib.conf not found, using default"
